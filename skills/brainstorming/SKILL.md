...
allowed-tools:
  ...
  - Glob
  - Grep
description: Generate high-signal solution options for Symfony problems, with tradeoffs and a recommended path.
---

# Brainstorming (Symfony)

## Use when
- The task explicitly involves brainstorming in a Symfony codebase.
