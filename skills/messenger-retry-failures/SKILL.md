...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for messenger retry failures with focused implementation guidance and validation.
---

# Messenger Retry Failures (Symfony)

## Use when
- The task explicitly involves messenger retry failures in a Symfony codebase.
