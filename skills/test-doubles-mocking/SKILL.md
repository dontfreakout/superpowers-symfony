...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for test doubles mocking with focused implementation guidance and validation.
---

# Test Doubles Mocking (Symfony)

## Use when
- The task explicitly involves test doubles mocking in a Symfony codebase.
