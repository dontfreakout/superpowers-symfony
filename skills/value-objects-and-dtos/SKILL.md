...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for value objects and dtos with focused implementation guidance and validation.
---

# Value Objects And Dtos (Symfony)

## Use when
- The task explicitly involves value objects and dtos in a Symfony codebase.
