...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for interfaces and autowiring with focused implementation guidance and validation.
---

# Interfaces And Autowiring (Symfony)

## Use when
- The task explicitly involves interfaces and autowiring in a Symfony codebase.
