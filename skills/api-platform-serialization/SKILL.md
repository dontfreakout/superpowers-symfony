...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for api platform serialization with focused implementation guidance and validation.
---

# Api Platform Serialization (Symfony)

## Use when
- The task explicitly involves api platform serialization in a Symfony codebase.
