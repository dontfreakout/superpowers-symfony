...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for doctrine fetch modes with focused implementation guidance and validation.
---

# Doctrine Fetch Modes (Symfony)

## Use when
- The task explicitly involves doctrine fetch modes in a Symfony codebase.
