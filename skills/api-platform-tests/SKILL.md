...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for api platform tests with focused implementation guidance and validation.
---

# Api Platform Tests (Symfony)

## Use when
- The task explicitly involves api platform tests in a Symfony codebase.
