...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for daily workflow with focused implementation guidance and validation.
---

# Daily Workflow (Symfony)

## Use when
- The task explicitly involves daily workflow in a Symfony codebase.
