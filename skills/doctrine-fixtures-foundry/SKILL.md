...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for doctrine fixtures foundry with focused implementation guidance and validation.
---

# Doctrine Fixtures Foundry (Symfony)

## Use when
- The task explicitly involves doctrine fixtures foundry in a Symfony codebase.
