...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for e2e panther playwright with focused implementation guidance and validation.
---

# E2e Panther Playwright (Symfony)

## Use when
- The task explicitly involves e2e panther playwright in a Symfony codebase.
