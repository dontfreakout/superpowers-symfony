...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for ports and adapters with focused implementation guidance and validation.
---

# Ports And Adapters (Symfony)

## Use when
- The task explicitly involves ports and adapters in a Symfony codebase.
