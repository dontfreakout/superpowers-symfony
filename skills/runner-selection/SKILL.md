...
allowed-tools:
  ...
  - Glob
  - Grep
description: Select the safest and fastest execution runner for this Symfony project (scripts, framework CLI, container, CI wrappers).
---

# Runner Selection (Symfony)

## Use when
- The task explicitly involves runner selection in a Symfony codebase.
