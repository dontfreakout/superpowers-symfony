...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for effective context with focused implementation guidance and validation.
---

# Effective Context (Symfony)

## Use when
- The task explicitly involves effective context in a Symfony codebase.
