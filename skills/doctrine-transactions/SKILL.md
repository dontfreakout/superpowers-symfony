...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for doctrine transactions with focused implementation guidance and validation.
---

# Doctrine Transactions (Symfony)

## Use when
- The task explicitly involves doctrine transactions in a Symfony codebase.
