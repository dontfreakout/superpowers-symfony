...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for config env parameters with focused implementation guidance and validation.
---

# Config Env Parameters (Symfony)

## Use when
- The task explicitly involves config env parameters in a Symfony codebase.
