...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for twig components with focused implementation guidance and validation.
---

# Twig Components (Symfony)

## Use when
- The task explicitly involves twig components in a Symfony codebase.
