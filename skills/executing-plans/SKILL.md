...
allowed-tools:
  ...
  - Glob
  - Grep
description: Execute an approved plan step-by-step in a Symfony codebase with checkpoint validation after each step.
---

# Executing Plans (Symfony)

## Use when
- The task explicitly involves executing plans in a Symfony codebase.
