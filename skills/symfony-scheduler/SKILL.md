...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for symfony scheduler with focused implementation guidance and validation.
---

# Symfony Scheduler (Symfony)

## Use when
- The task explicitly involves symfony scheduler in a Symfony codebase.
