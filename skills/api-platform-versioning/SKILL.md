...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for api platform versioning with focused implementation guidance and validation.
---

# Api Platform Versioning (Symfony)

## Use when
- The task explicitly involves api platform versioning in a Symfony codebase.
