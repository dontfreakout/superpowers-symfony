...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for using symfony superpowers with focused implementation guidance and validation.
---

# Using Symfony Superpowers (Symfony)

## Use when
- The task explicitly involves using symfony superpowers in a Symfony codebase.
