...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for controller cleanup with focused implementation guidance and validation.
---

# Controller Cleanup (Symfony)

## Use when
- The task explicitly involves controller cleanup in a Symfony codebase.
