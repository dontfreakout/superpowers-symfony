...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for api platform security with focused implementation guidance and validation.
---

# Api Platform Security (Symfony)

## Use when
- The task explicitly involves api platform security in a Symfony codebase.
