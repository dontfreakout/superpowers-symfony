...
allowed-tools:
  ...
  - Glob
  - Grep
description: Apply production-grade Symfony practices for symfony cache with focused implementation guidance and validation.
---

# Symfony Cache (Symfony)

## Use when
- The task explicitly involves symfony cache in a Symfony codebase.
