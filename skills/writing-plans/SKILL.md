...
allowed-tools:
  ...
  - Glob
  - Grep
description: Create a concise, dependency-aware implementation plan for Symfony work with validation checkpoints.
---

# Writing Plans (Symfony)

## Use when
- The task explicitly involves writing plans in a Symfony codebase.
